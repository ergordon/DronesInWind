...
Ultimately, the results will be compared to \textbf{one} of D'Andrea's results \textcolor{red}{Citation Needed}. 
...
\end{lstlisting}
\end{quote}
The preceding lines of code are meant to show how easily the data can be unpacked and plotted against each other. Below, \textcolor{blue}{\textbf{Figure X} shows the optimal and actual state of the quadrotor and \textbf{figure Y} shows the optimal and actual inputs of the quadrotor.}
...
\begin{figure}[h!]
  ...
  \begin{minipage}[b]{0.45\textwidth}
    ...
    \caption{Quadcopter state over time.}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{Inputs.png}
    \caption{Quadcopter Inputs over time.}
  \end{minipage}
\end{figure}
